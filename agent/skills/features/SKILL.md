...
2. Delegate to the **analyst** agent: produce/revise `project/00-business/feature-list.md`
   from `templates/feature-list.md`. Every FT traces to ≥1 FR; every MVP FR is covered by
