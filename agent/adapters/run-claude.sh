#!/usr/bin/env bash
# Usage: run-claude.sh E03-T07 "Follow agent/workflows/implement-task.md for E03-T07"
set -euo pipefail
...
python3 agent/orchestrator/metrics_collect.py --task "$TASK" --platform claude-code --result "$OUT"
