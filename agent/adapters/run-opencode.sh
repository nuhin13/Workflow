#!/usr/bin/env bash
# Usage: run-opencode.sh E03-T07 "Follow agent/workflows/implement-task.md for E03-T07"
set -euo pipefail
...
python3 agent/orchestrator/metrics_collect.py --task "$TASK" --platform opencode --result "$OUT" --no-cost
