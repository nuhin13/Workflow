# /retro E<NN>  (agents: pm + team-lead; orchestrator compiles evidence)
1. Evidence bundle: tracker history, QA verdicts, bug list, metrics.csv
   (est vs actual), handoff packets, human feedback notes.
