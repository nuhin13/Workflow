...
superseded C", "task X TOUCHES file F"). Server setup: `harness/mcp/graphiti.md`.
Schema: `harness/memory/graphiti/schema.md`.
...
## Rules
- Files in `harness/memory/` remain the human-editable source of truth; the
