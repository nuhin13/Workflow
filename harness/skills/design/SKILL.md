...
2. **Figma precedence:** if `workspace/docs/design/README.md` links a Figma file, that design is
...
3. Produce in `workspace/plan/01-design/`:
...
**import:** read `workspace/assets/design-imports/*`, extract palette/type/spacing/components
