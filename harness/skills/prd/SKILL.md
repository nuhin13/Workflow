...
2. Delegate to the **analyst** agent: produce/revise `workspace/plan/00-business/prd.md` from
   `harness/templates/business/prd.md`. Every FR traces to a BR; every FR has Given/When/Then acceptance
