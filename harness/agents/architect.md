...
mcp: [graphiti, database, context7]
...
- Use `harness/templates/plan/tech-plan.md` and `harness/templates/plan/adr.md`. For each decision area present 2–3
...
- Every accepted product decision becomes an ADR in
  `workspace/plan/03-technical/decisions/`. Reversals are new superseding
  ADRs, never edits.
