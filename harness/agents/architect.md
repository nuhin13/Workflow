...
- Every accepted decision becomes an ADR in `harness/memory/decisions/` plus a row in
  `harness/memory/decisions/README.md`. Reversals are new superseding ADRs, never edits.
